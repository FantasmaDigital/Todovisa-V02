...
export default function AcreditacionPage() {
  ...
  // Fetch agent application from Supabase
  const loadAgentApplication = async () => {
    ...
    try {
      ...
      console.error("Error loading agent application:", err);
    } finally {
      setLoading(false);
    }
  };
      ...
      <main className="w-[80%] mx-auto py-10 flex-grow text-left">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            {/* Submitted Documentation side cards */}
            <div className="lg:col-span-1 border border-border-light rounded-sm p-6 bg-white space-y-4">
              <div>
              ...
              <div className="space-y-3.5 text-xs text-text-primary">
                {Object.entries(agent.documents).map(([key, val]) => (
