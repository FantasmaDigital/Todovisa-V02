...
export const VIPROQuestionsUSA: VIPROQuestionsProps[] = [
    ...
    { question: "¿Has sufrido daño o maltrato en tu país?", type_question: "opcion multiple", response: ["Sí", "No"], user_response: "", category: "USA - E PREGUNTAS DE SEGURIDAD" },
    { question: "¿Temes regresar a tu país?", type_question: "opcion multiple", response: ["Sí", "No"], user_response: "", category: "USA - E PREGUNTAS DE SEGURIDAD" },
    { question: "¿Has sido amenazado o planeas pedir asilo?", type_question: "opcion multiple", response: ["Sí", "No"], user_response: "", category: "USA - E PREGUNTAS DE SEGURIDAD" },
    { question: "¿Cuenta con una petición formal o patrocinio de un patrono o empresa en EE.UU.?", type_question: "opcion multiple", response: ["Sí", "No"], user_response: "", category: "USA - C.1 DETALLES VISA" },
