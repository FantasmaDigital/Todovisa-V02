...
export const AgentNetwork = () => {
    ...
    return (
        <section id="unirte-red" className="w-full mx-auto flex flex-col">
            ...
            <div className="w-full bg-brand-primary px-6 sm:px-10 py-8 relative overflow-hidden">
                ...
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
                    ...
                    <div className="w-full lg:w-1/2 flex items-center justify-center">
                        <div className="w-full max-w-xl flex flex-col items-start text-left">
                            <span className="text-xs font-bold uppercase tracking-[0.2em] text-brand-primary mb-3">ÚNETE A LA RED</span>
                            ...
                            <Link href="/agents/apply" className="bg-brand-primary text-white font-semibold px-8 py-3.5 rounded-sm hover:bg-brand-hover transition-colors text-sm border-none focus:outline-none inline-block text-center shadow-xs">
                    ...
                    <div className="w-full lg:w-1/2">
                        <div className="relative w-full max-w-xl mx-auto lg:max-w-none aspect-[4/5] md:aspect-square overflow-hidden rounded-xl border border-border-light shadow-xs bg-white">
                            <img
