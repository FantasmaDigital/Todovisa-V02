    ...
    return (
        <section className="py-24 w-[90%] max-w-4xl m-auto flex flex-col items-center text-center">
            ...
            <div className="flex flex-row gap-4 mt-12 flex-wrap justify-center">
                ...
                <a href="/preformulario" className="bg-white text-text-primary border border-border-light hover:bg-gray-50 font-bold px-8 py-3.5 rounded-lg text-sm transition-all duration-200 shadow-sm focus:outline-none cursor-pointer">
                    Iniciar Trámite
                </a>
            </div>
        </section>
