                ...
                <div className="flex flex-col w-full py-3">
                    <nav className="w-[88%] m-auto flex flex-row items-center">
                        ...
                        <div className="flex items-center justify-around min-w-full">
                            ...
                            <button className="bg-brand-primary text-white px-4 py-2 rounded">Buscar Agentes</button>
                            <button className="bg-white text-brand-primary px-4 py-2 rounded">Unirme a la Red</button>
                        </div> */}
                        </div>

                        {
                            !isMounted ? (
                                ...
                                <div className="flex flex-row items-center gap-4 ml-auto relative group py-2">
                                    ...
                                    {/* Dropdown Menu on hover/group-hover */}
